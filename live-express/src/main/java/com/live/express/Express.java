package com.live.express;

import com.live.express.util.Base64;
...
public class Express {
    ...
    public  String sendGet(String url, String secretId, String secretKey) {
        String result = "";
    ...
    public String sign (String secret, String timeStr)
