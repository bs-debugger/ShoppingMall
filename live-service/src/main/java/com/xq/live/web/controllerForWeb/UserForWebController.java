...
public class UserForWebController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/approve/addUserUnionId", method = RequestMethod.POST)
     ...
     * @return
     */
    @RequestMapping(value = "/approve/findByCode",method = RequestMethod.GET)
...
//        String pwd = bCryptPasswordEncoder.encode(in.getPassword());
     ...
     * @param inVo
     * @return
     * localhost:8080/user/invite?parentId=52762&skuId=1280&shopId=35&createTime=2018-08-31
     */
     ...
     * @param inVo
     * @return
     * localhost:8080/user/getNewUser?parentId=52762&skuId=1280
     */
     ...
     * @param inVo
     * @return
     * user/upPeopleNum?parentId=52762&skuId=1280&shopId=35&newUser=32879
     */
     ...
     * @param inVo
     * @return
     * localhost:8080/user/myRedislist?parentId=52762
     */
     ...
     * @param inVo
     * @return
     * localhost:8080/user/getGoodsSkuAndUserList?parentId=52762&skuId=1280&actId
     */
     ...
     * @param inVo
     * @return
     * localhost:8080/user/mySencondsKillList?parentId=52762&actId
     */
     ...
     * @param inVo
     * @return
     * user/updatePeopleNumNew?parentId=52762&skuId=1280&shopId=35&newUser=32879&actId
     */
     ...
     * @param inVo
     * @return
     * localhost:8080/user/inviteNewPeople?parentId=52762&skuId=1280&shopId=35&actId
     */
    @RequestMapping("inviteNewPeople")
