 ...
 */
@RestController
@RequestMapping("/clientApp/wxpayNotify")
public class WxpayNotifyForClientAppController {

    private Logger logger = Logger.getLogger(WxpayNotifyForClientAppController.class);
    ...
    public WxpayNotifyForClientAppController() throws Exception {
