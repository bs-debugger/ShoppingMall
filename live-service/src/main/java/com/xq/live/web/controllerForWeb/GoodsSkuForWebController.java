 ...
 **/
@RestController
@RequestMapping("/website/goodsSku")
public class GoodsSkuForWebController {
     ...
     * @return
     */
    @RequestMapping(value = "/approve/selectDetailBySkuId", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/approve/listNew", method = RequestMethod.GET)
     ...
     * actId categoryId
     */
    @RequestMapping(value = "/approve/listForAct", method = RequestMethod.GET)
     ...
     * actId categoryId
     */
    @RequestMapping(value = "/approve/listForEndAct", method = RequestMethod.GET)
     ...
     * actId categoryId id
     */
    @RequestMapping(value = "/approve/listForActOut", method = RequestMethod.GET)
