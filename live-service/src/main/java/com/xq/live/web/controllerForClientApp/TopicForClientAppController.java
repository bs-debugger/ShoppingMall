 ...
 **/
@RestController
@RequestMapping(value = "/clientApp/topic")
public class TopicForClientAppController {
    ...
    public BaseResp<Long> add(@RequestBody @Valid Topic topic, BindingResult result) {
        if (result.hasErrors()) {
