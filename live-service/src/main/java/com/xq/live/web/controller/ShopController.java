...
/*    @RequestMapping(value = "/delete/{id}", method = RequestMethod.DELETE)
     ...
     * @return
     */
    @RequestMapping(value = "/listForSkuAllocation", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/listForFastFood", method = RequestMethod.GET)
    public BaseResp<Pager<ShopOut>> listForFastFood(ShopInVo inVo, HttpServletRequest request){
        if(inVo!=null&&inVo.getShopCate()==null){
            inVo.setShopCate("48");//轻餐饮的shopcategoryID为48
        }
        Pager<ShopOut> result = shopService.listForGoodsSku(inVo);
        return new BaseResp<Pager<ShopOut>>(ResultStatus.SUCCESS, result);
    }
     ...
     * @return
     */
    @RequestMapping(value = "/listForGoodsSku", method = RequestMethod.GET)
    public BaseResp<Pager<ShopOut>> listForGoodsSku(ShopInVo inVo, HttpServletRequest request){
        Pager<ShopOut> result = shopService.listForGoodsSku(inVo);
        return new BaseResp<Pager<ShopOut>>(ResultStatus.SUCCESS, result);
    }
    ...
    public BaseResp<Pager<ShopOut>> listForVip(ShopInVo inVo, HttpServletRequest request){
        Pager<ShopOut> result = shopService.listForVip(inVo);
        return new BaseResp<Pager<ShopOut>>(ResultStatus.SUCCESS, result);
    }
