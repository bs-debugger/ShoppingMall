 ...
 */
@RestController
@RequestMapping("/website/actGoodsSku")
public class ActGoodsSkuForWebController {
     ...
     * @return
     */
    @RequestMapping(value = "/approve/getSpuList", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/approve/jackpotList", method = RequestMethod.GET)
