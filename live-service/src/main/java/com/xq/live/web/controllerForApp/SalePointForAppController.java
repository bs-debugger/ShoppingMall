 ...
 */
@RestController
@RequestMapping(value="/app/salePoint")
public class SalePointForAppController {
    ...
    /**
     * 通过商品id和销售点id删除商品销售点关系
     * @param salePointInVo
     * @return
     */
    @RequestMapping(value = "/deleteGoodsSkuBySalePointId",method = RequestMethod.POST)
    public BaseResp<Integer> deleteGoodsSkuBySalePointId(SalePointInVo salePointInVo){
        int re = salePointService.deleteGoodsSkuBySalePointId(salePointInVo);
        if(re>0) {
