...
public class ActShopController {
     ...
     * 分页查询参加活动的商家列表
     *
     *注:voteUserId是当前用户的userId，所以可以从网关中获取
     * @param inVo
     * @return
     */
    ...
    @ApiOperation(value = "万达权益卡买单打折")
    @RequestMapping(value = "/listShopDiscount", method = RequestMethod.GET)
    public BaseResp<Pager<ActShopOut>> listShopDiscount(ActShopInVo inVo, HttpServletRequest request){
