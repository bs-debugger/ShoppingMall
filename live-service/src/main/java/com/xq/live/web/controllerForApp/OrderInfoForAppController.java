 ...
 */
@RestController
@RequestMapping(value = "/app/orderInfo")
public class OrderInfoForAppController {
     ...
     * @return
     */
    @RequestMapping(value = "/queryShopTurnoverV1",method = RequestMethod.GET)
    public BaseResp<Map<String,String>> queryShopTurnoverV1(OrderInfoInVo inVo){
        Map<String,String> map = orderInfoService.queryShopTurnoverV1(inVo);
        return new BaseResp<Map<String, String>>(ResultStatus.SUCCESS,map);
    }
